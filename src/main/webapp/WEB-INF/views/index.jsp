...
<div class="recent homeimg">
      <h2>RECENT WORKS</h2>
      <ul>
        <li><a href="#" target="_blank" title=""><img src="/img/pre_13.jpg" 
...
class="img"/></a></li>
        <li><a href="#" target="_blank" title=""><img src="/img/pre_2.jpg" 

width="270" height="182" alt="" border="0" class="hover n2" /><img 

src="/img/pre_14.jpg" width="270" height="182" alt="" border="0" 

class="img"/></a></li>
        <li class="mr0"><a href="#" target="_blank" title=""><img 
...
class="img"/></a></li>
        <li><a href="#" target="_blank" title=""><img src="/img/pre_4.jpg" 

width="270" height="182" alt="" border="0" class="hover n4" /><img 

src="/img/pre_16.jpg" width="270" height="182" alt="" border="0" 

class="img"/></a></li>
        <li><a href="#" target="_blank" title=""><img src="/img/pre_17.jpg" 
...
src="/img/pre_6.jpg" width="270" height="182" alt="" border="0" class="hover 

n6"/><img src="/img/pre_18.jpg" width="270" height="182" alt="" border="0" 
