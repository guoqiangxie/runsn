...
<div class="sidebar">
    <div style="height:160px; overflow:hidden;"> <span>你好，管理员，欢迎登陆管理中心!</span>
        <h2>后台管理首页</h2>
    </div>
    <ul>
        ...
        <li class="12"><a href="/admin/image/image_activity1.html">精彩促销图片</a></li>
        <li class="13"><a href="/admin/image/image_activity2.html">厂商&活动图片</a></li>
