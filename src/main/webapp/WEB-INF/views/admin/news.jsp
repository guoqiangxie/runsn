    ...
    <div class="c_main">
      ...
      <div class="main2">
        <div class="tit">
          ...
          <span></span></div>
          <div class="newsure">
              <input id="addService" name="input" type="button" value="添加新闻" />
          </div>
        <div class="tmain b5 btop">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <c:forEach var="service" items="${news}">
                  <tr>
                      <td><span class="info"><a href="/admin/newsDetail/${service.id}">${service.title}</a></span></td>
                      <td>${service.createDate}</td>
                      <td>${service.updateDate}</td>
                      <td align="center"><a href="/admin/newsDetail/${service.id}">修改</a> <a href="/admin/delete/${service.id}" onclick="return confirm('是否将(${service.title})信息删除?')">删除</a></td>
                  </tr>
              </c:forEach>
          </table>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#addService").click(function() {
            window.location.href = "/admin/newsDetail/0";
        });
    });
</script>
</body>
