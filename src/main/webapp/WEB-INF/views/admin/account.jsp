...
<div class="main2">
  <div class="tmain b5">
    <div class="tipsinfo b5"><span>牢记密码，切勿将密码泄露于不相关的人，以免造成不必要的麻烦！</span><b></b></div>
    <div class="txt">　　　原始密码：
      <input class="w250 b5" name="" type="text" />
    </div>
    <div class="txt">　　新密码密码：
      <input class="w250 b5" name="" type="text" />
    </div>
    <div class="txt">再次输入新密码：
      <input class="w250 b5" name="" type="text" />
    </div>
    <div class="sure">
      <input name="" type="button" value="更改密码" />
    </div>
  </div>
</div>
