        ...
        <div class="tmain b5 btop">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <c:forEach var="service" items="${activities}">
                  <tr>
                      <td><span class="info"><a href="/admin/activityDetail/${imageType}/${service.id}">${service.imageDesc}</a></span></td>
                      <td>${service.createDate}</td>
                      <td>${service.updateDate}</td>
                      <td align="center"><a href="/admin/activityDetail/${imageType}/${service.id}">修改</a> <a href="/admin/deleteActivity/${service.id}" onclick="return confirm('是否将(${service.imageDesc})信息删除?')">删除</a></td>
                  </tr>
              </c:forEach>
          </table>
        </div>
